          ...
          <div className="lg:flex xs:grid xs:grid-cols-1 justify-between pe-2">
            <div className=" p-2 lg:w-full flex flex-col gap-5 xs:order-2 lg:order-1">
              <label className="w-full">
                ...
                <input type="text" className="w-full p-2 shadow-md rounded bg-sky-300 text-sky-800 focus:outline-none need-validation" maxLength={30} value={rentalFormData.address1} onChange={(e)=> setRentalFormData({...rentalFormData, address1: e.target.value})} required/>
              </label>
              <label className="w-full">
                ...
                <input type="text" className="w-full p-2 shadow-md rounded bg-sky-300 text-sky-800 focus:outline-none need-validation" maxLength={30} value={rentalFormData.address2} onChange={(e)=> setRentalFormData({...rentalFormData, address2: e.target.value})} required/>
              </label>
