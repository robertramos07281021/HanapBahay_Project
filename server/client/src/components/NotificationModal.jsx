...
const NotificationModal = ({children, bg, query, navigation}) => {
  ...
  return ( 
    <>
      { notification &&
        <div className={`fixed flex flex-col xs:top-20 z-50  xs:left-0 md:left-auto md:top-20 lg:top-24 md:right-4 ${bg} rounded shadow-xl h-14 xs:w-full md:w-96  text-white font-bold tracking-wider overflow-hidden`}>
